...
def insert_cover(cover_pdf, body_pdf, output_pdf):
    ...
    writer.add_metadata({'/Title': 'Report Title', '/Author': 'VaultGate', '/Creator': 'VaultGate'})
...
doc = SimpleDocTemplate(
    ...
    author='VaultGate', creator='VaultGate'
)
...
- [ ] **Metadata**: Title matches filename, Author/Creator = "VaultGate"
