...
author: VaultGate (adapted from ShinMegamiBoson/OpenPlanter, MIT)
metadata:
  vaultgate:
...
# $VAULTGATE_OSINT_CACHE/icij/ (default: ~/.cache/vaultgate-osint/icij/).
...
# Set VAULTGATE_OSINT_UA=your-app/1.0 (your@email) to identify yourself
