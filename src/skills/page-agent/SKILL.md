...
- User wants **VaultGate itself to drive a browser** → use VaultGate' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
