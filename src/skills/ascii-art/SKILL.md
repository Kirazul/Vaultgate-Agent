...
```bash
python3 -m pyfiglet "VAULTGATE" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=VAULTGATE&font=Slant" | boxes -d stone
```
