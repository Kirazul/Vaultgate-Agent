...
- **Gateway Base URL:** `GATEWAY_URL` (e.g., `https://internal-api.VaultGate`)
...
- **Required Header:** `X-VaultGate-From: Z`
...
**Example:**
- Full URL: `https://internal-api.VaultGate/external/finance/v1/markets/search?search=Apple`
- Breakdown:
  - `https://internal-api.VaultGate` - Gateway base URL (`GATEWAY_URL`)
...
1. **Authentication Header** - Always include `X-VaultGate-From: Z` header
